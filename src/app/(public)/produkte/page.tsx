...
export default async function ProduktePage({ searchParams }: ProduktePageProps) {
    ...
    return (
        <div className="min-h-screen relative bg-gradient-to-b from-[#fffdf8] via-[#fef9e7] to-[#fffdf8]">
            <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16 relative z-10">
                <div className="mb-8 sm:mb-12 text-center bg-white/70 backdrop-blur-sm p-5 sm:p-8 rounded-[24px] sm:rounded-[28px] border border-orange-100 shadow-lg shadow-orange-500/5 inline-block mx-auto max-w-4xl flex flex-col items-center">
                    <h1 style={{ fontFamily: 'var(--font-fredoka), sans-serif' }} className="text-[clamp(1.9rem,8vw,3rem)] text-[#f13c20] mb-3 sm:mb-4">
                        🎈 Unsere Eventmodule! 🎈
                    </h1>
                    <p className="font-['Nunito'] text-[15px] sm:text-[18px] text-[#475569] leading-[1.6] sm:leading-[28px] max-w-[800px] font-medium">
                        Entdecken Sie unsere bunte Auswahl: Ob coole <strong className="font-bold text-[#f13c20]">Hüpfburg</strong>, eine süße <strong className="font-bold text-[#ff7a3d]">Candybar</strong> für die Feier oder spannende <strong className="font-bold text-[#45b854]">Kinderspiele</strong> – wir bringen den Spaß direkt zu Ihrem Event!
                    </p>
                </div>
